...
import {
    ...
    View, Modal, Clipboard, ToastAndroid,
    AlertIOS, Platform, ScrollView
} from 'react-native';
...
import { toggleShareModalVisibility, setSharableContent, registerShare } from './../../../redux/actions';
...
class SocialShare extends Component {
    ...
    onCancel() {
        ...
        this.props.toggleShareModalVisibility(false);
    }

    onOpen() {
        this.props.toggleShareModalVisibility(true);

    }

    shareWithCompatibleApps(data) {
        Share.open(data);
    ...
    render() {
        ...
        const { message, url, subject, postuuid } = this.props;
        ...
        const TWITTER_COLOR = SITE_COLOR;
        const FACEBOOK_COLOR = '#4267b2';

        return (
            <Modal
                transparent
                visible={this.props.shareVisibility}
                onRequestClose={() => { console.log("closed") }}
                animationType="slide"

            >
                <View style={{ flex: 1, marginTop: 300 }}>
                    <TouchableOpacity style={{ backgroundColor: SITE_COLOR, paddingTop: 10, paddingBottom: 10 }} onPress={() => this.props.toggleShareModalVisibility(false)}>
                        <Icon name="window-close" color={WHITE} style={{ textAlign: 'center', }} size={25} />
                    </TouchableOpacity>
                    ...
                    <ScrollView style={{ backgroundColor: WHITE }}>
                            ...
                            onPress={() => {
                                ...
                                setTimeout(() => {
                                    Share.shareSingle(Object.assign(shareOptions, {
                                        "social": "twitter"
                                    })).then(res => this.props.registerShare(this.props.postuuid))
                                        .catch(err => console.log(err));
                                }, 300);
                            }}><Icon name="twitter" color={TWITTER_COLOR} size={20} />    Twitter</Button>
                        ...
                        <Button
                            ...
                            }}><Icon name="facebook-box" color={TWITTER_COLOR} size={20} />    Facebook</Button>
                        ...
                        <Button
                            ...
                            }}><Icon name="whatsapp" color={TWITTER_COLOR} size={20} />    Whatsapp
                        </Button>
                        ...
                        <Button
                            ...
                            }}><Icon name="google-plus-box" color={TWITTER_COLOR} size={20} />    Google +
                        ...
                        <Button
                            ...
                            }}><Icon name="mailbox" color={TWITTER_COLOR} size={20} />    Email
                            </Button>
                        ...
                        <Button
                            ...
                            }}><Icon name="pinterest-box" color={TWITTER_COLOR} size={20} />    Pinterest
...
const mapStateToProps = (state) => {
    ...
    const { shareVisibility, url, message, subject, postuuid } = state.share;

    return { shareVisibility, url, message, subject, postuuid }
};

export default connect(mapStateToProps, { toggleShareModalVisibility, setSharableContent, registerShare })(SocialShare); 
